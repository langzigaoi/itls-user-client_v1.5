    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            size="mini"
            v-if="showFlag.setupForm == true"
            :disabled="disableFlag.setupForm == true"
            @click="openSetupForm(scope.$index, scope.row)"
            >试题设置</el-button
          >
...
<style scoped>
div /deep/ .order .el-table__header-wrapper .el-checkbox {
  display: none;
}
.conf {
