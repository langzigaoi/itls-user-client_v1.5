<template>
  <div id="all">
    ...
    <div class="btn">
      <router-link class="addMidsemesterExam" to="/course/AddMidseMesterExam"><el-button type="primary">添加期中考试</el-button></router-link>
    </div>
    <el-divider></el-divider>
    <div class="table">
      <el-table
    ...
    >
      ...
      <el-table-column prop="startRange" label="开始范围" width="120">
      </el-table-column>
      <el-table-column prop="endRange" label="截至范围" width="120">
      </el-table-column>
