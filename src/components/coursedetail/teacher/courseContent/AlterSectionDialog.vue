<template>
    <div>
        <el-dialog title="修改小讲" top="3vh" :visible.sync="dialogVisible" width="40%" :before-close="handleClose">
            <!-- {{global}} -->
            <div >
        ...
        <el-dialog  style="z-index:2300" width="60%" title="请输入文件名" :visible.sync="customFileNameDialog" :close-on-click-modal="false">
            <p>文件名
                <el-select @change="fileNameChange" filterable  style="width:100%;height:100%" v-model="customFileName1"  placeholder="请选择知识点">
    ...
    methods:{
     ...
     // 将修改的东西提交
      submit(){
        ...
        //   })
        //   submitsection.pptId = submitsection.pptId.toString();
         //处理video的id
