    ...
    >
      ...
      >
        ...
        <el-form-item label="题目来源" prop="markup">
          <el-input v-model="dataForm.markup" auto-complete="off"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      dataFormRules: {
        ...
        markup: [
          { required: true, message: "请输入题目来源", trigger: "blur" },
        ],
      },
    };
  },
  methods: {
    ...
    submitForm() {
      ...
      this.$api.course.shortAnserQues
        .updateShortAnserQuesByid(this.dataForm)
        .then((res) => {
          console.log(res);
          this.$message.success(res.msg)
          this.$emit('editSAQSuccess')
        });
    },
  },
};
